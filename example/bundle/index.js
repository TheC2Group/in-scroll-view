...
var readScroll = debounceAf_1(function () {
...
var measure = debounceAf_1(function () {
  height = $w.height();
  collection.forEach(function (item) {
...
view.add = function (els, options) {
  var $els = jquery(els);
  var opts = jquery.extend({}, itemDefaults, options);

  if ($els.length === 1) {
    createItem($els, opts);
  } else {
    $els.each(function () {
      createItem(jquery(this), opts);
    });
  }
